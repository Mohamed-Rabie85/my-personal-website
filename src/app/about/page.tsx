  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="w-full py-16 bg-gray-50 dark:bg-slate-800">
        <div className="section-container">
          <div className="text-center mb-12">
            <h2 className="text-[rgb(var(--primary-dark))]">منهجيتي الفريدة والشاملة</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold mb-2">التخطيط الاستراتيجي الدقيق</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold mb-2">علم النفس التسويقي التطبيقي</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold mb-2">الخبرة التنفيذية والتقنية المتكاملة</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
      ...
      <section className="w-full py-16 bg-white dark:bg-slate-900">
        <div className="section-container">
          <div className="text-center mb-12">
            <h2 className="text-[rgb(var(--primary-dark))]">الخبرات التقنية</h2>
            <p className="text-[rgb(var(--neutral-medium))] max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="card text-center">
              <div className="mb-4 text-[rgb(var(--secondary-dark))] flex justify-center">
                <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">تحليل البيانات</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
      ...
      <section className="w-full py-16 bg-gray-50 dark:bg-slate-800">
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-[rgb(var(--primary-dark))] mb-6">رؤيتي المهنية</h2>
              <p className="mb-4 text-[rgb(var(--neutral-medium))]">
            ...
            <div>
              <h2 className="text-[rgb(var(--primary-dark))] mb-6">قيمي الأساسية</h2>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold">الشفافية والأخلاق</h3>
                    <p className="text-[rgb(var(--neutral-medium))]">الالتزام بأعلى معايير الأخلاق المهنية والشفافية في جميع التعاملات.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    <h3 className="font-semibold">التعلم المستمر</h3>
                    <p className="text-[rgb(var(--neutral-medium))]">الشغف بالمعرفة وتطوير الذات باستمرار لتقديم أحدث الاستراتيجيات والممارسات.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    <h3 className="font-semibold">النتائج الملموسة</h3>
                    <p className="text-[rgb(var(--neutral-medium))]">التركيز على تحقيق نتائج قابلة للقياس وتحويل الاستراتيجيات إلى واقع ملموس.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    <h3 className="font-semibold">الشراكة الحقيقية</h3>
                    <p className="text-[rgb(var(--neutral-medium))]">العمل كامتداد لفريق العملاء، ومشاركتهم التحديات والنجاحات.</p>
                  </div>
                </li>
              </ul>
            </div>
