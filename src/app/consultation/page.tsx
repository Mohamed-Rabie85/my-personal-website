      ...
      <section className="w-full py-16 bg-white dark:bg-slate-900">
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-[rgb(var(--primary-dark))] mb-6">ماذا تتضمن الاستشارة المجانية؟</h2>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold">تحليل الوضع الحالي</h3>
                    <p className="text-[rgb(var(--neutral-medium))]">مناقشة وضع عملك الحالي، التحديات التي تواجهها، والفرص المتاحة للنمو.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    ...
                    <p className="text-[rgb(var(--neutral-medium))]">تحديد أهدافك قصيرة وطويلة المدى، وما الذي تطمح لتحقيقه في عملك.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    ...
                    <p className="text-[rgb(var(--neutral-medium))]">تقديم أفكار واستراتيجيات أولية يمكن أن تساعدك في تحقيق أهدافك.</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <div className="text-[rgb(var(--secondary-medium))]">
                  ...
                  <div>
                    ...
                    <p className="text-[rgb(var(--neutral-medium))]">مناقشة الخطوات التالية وكيف يمكننا العمل معًا لتحقيق أهدافك.</p>
                  </div>
                </li>
              </ul>
              <p className="text-[rgb(var(--neutral-medium))] italic mb-6">
                الاستشارة المجانية تستغرق حوالي 30 دقيقة، وتتم عبر مكالمة فيديو أو هاتفية حسب تفضيلك.
              </p>
            </div>
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-[rgb(var(--primary-dark))]">احجز موعدك الآن</h3>
              <form className="space-y-4">
                ...
                <div>
                  <label htmlFor="company" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">اسم الشركة</label>
                  <input type="text" id="company" name="company" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]" placeholder="أدخل اسم شركتك" />
                </div>
                <div>
                  <label htmlFor="consultation_type" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">نوع الاستشارة</label>
                  <select id="consultation_type" name="consultation_type" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]">
                    <option value="">اختر نوع الاستشارة</option>
                    <option value="strategic_planning">التخطيط الاستراتيجي</option>
                    <option value="digital_marketing">التسويق الرقمي</option>
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">رسالتك</label>
                  <textarea id="message" name="message" rows={4} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]" placeholder="اشرح باختصار ما هي احتياجاتك وأهدافك"></textarea>
                </div>
                <div>
                  <label htmlFor="preferred_date" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">التاريخ المفضل</label>
                  <input type="date" id="preferred_date" name="preferred_date" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]" />
                </div>
                <div>
                  <label htmlFor="preferred_time" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">الوقت المفضل</label>
                  <select id="preferred_time" name="preferred_time" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]">
                    <option value="">اختر الوقت المفضل</option>
                    <option value="morning">صباحًا (9:00 - 12:00)</option>
                    <option value="afternoon">ظهرًا (12:00 - 3:00)</option>
                    <option value="evening">مساءً (3:00 - 6:00)</option>
                  </select>
                </div>
                <div>
                  <label htmlFor="communication_preference" className="block text-sm font-medium text-[rgb(var(--neutral-dark))] mb-1">طريقة التواصل المفضلة</label>
                  <select id="communication_preference" name="communication_preference" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-light))]">
      ...
      <section className="w-full py-16 bg-gray-50 dark:bg-slate-800">
        <div className="section-container">
          <div className="text-center mb-12">
            <h2 className="text-[rgb(var(--primary-dark))]">الأسئلة الشائعة</h2>
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            <div className="card">
              <h3 className="text-lg font-semibold mb-2 text-[rgb(var(--primary-dark))]">هل الاستشارة المجانية ملزمة بالتعاقد؟</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-semibold mb-2 text-[rgb(var(--primary-dark))]">كيف تتم عملية العمل بعد الاستشارة المجانية؟</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold mb-2 text-[rgb(var(--primary-dark))]">ما هي مدة المشاريع الاستشارية؟</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold mb-2 text-[rgb(var(--primary-dark))]">هل تقدم خدمات للشركات خارج المملكة العربية السعودية؟</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold mb-2 text-[rgb(var(--primary-dark))]">كيف يمكنني قياس نجاح الاستشارة؟</h3>
              <p className="text-[rgb(var(--neutral-medium))]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="card">
              <div className="p-6">
                ...
                <p className="text-[rgb(var(--neutral-medium))] mb-4">&quot; بدأت العلاقة باستشارة مجانية، وكانت هذه الاستشارة وحدها ذات قيمة كبيرة. الأفكار والرؤى التي قدمها خلال الاستشارة المجانية كانت كافية لإقناعي بالعمل معه. النتائج التي حققناها تجاوزت توقعاتنا بكثير. &quot;</p>
