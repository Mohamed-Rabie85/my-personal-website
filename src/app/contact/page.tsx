      ...
      <section className="w-full py-16 bg-white dark:bg-slate-900">
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* معلومات الاتصال */}
            <div>
              <h2 className="text-[rgb(var(--primary-dark))] mb-6">معلومات الاتصال</h2>
              <p className="mb-8 text-[rgb(var(--neutral-medium))]">
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  <a href="#" className="text-[rgb(var(--neutral-medium))] hover:text-[rgb(var(--primary-medium))] transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="w-full py-16 bg-[rgb(var(--primary-dark))] text-white">
        <div className="section-container text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <Link href="#" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md hover:bg-white hover:text-[rgb(var(--primary-dark))] transition-colors duration-300">
              اتصل بنا
            </Link>
          </div>
        </div>
