      ...
      <section className="w-full bg-background text-white py-20 md:py-32">
        <div className="section-container text-center md:text-right">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
            ...
            <Link href="/about" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md hover:bg-white hover:text-[rgb(var(--primary-dark))] transition-colors duration-300">
              تعرف علي أكثر
            </Link>
          </div>
        </div>
      ...
      <section className="w-full py-16 bg-background">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* بطاقة الخدمة 1 */}
            <div className="card hover:border-r-4 hover:border-r-[rgb(var(--secondary-medium))]">
              <div className="mb-4 text-[rgb(var(--secondary-dark))]">
                {/* هنا يمكن إضافة أيقونة */}
              ...
              <Link href="/services#strategic-planning" className="mt-4 inline-block text-[rgb(var(--primary-medium))] hover:text-[rgb(var(--primary-dark))] font-medium">
                اكتشف المزيد &larr;
              </Link>
            </div>
            ...
            <div className="card hover:border-r-4 hover:border-r-[rgb(var(--secondary-medium))]">
              ...
              <Link href="/services#digital-marketing" className="mt-4 inline-block text-[rgb(var(--primary-medium))] hover:text-[rgb(var(--primary-dark))] font-medium">
                اكتشف المزيد &larr;
              </Link>
            </div>
            ...
            <div className="card hover:border-r-4 hover:border-r-[rgb(var(--secondary-medium))]">
              ...
              <Link href="/services#data-analysis" className="mt-4 inline-block text-[rgb(var(--primary-medium))] hover:text-[rgb(var(--primary-dark))] font-medium">
                اكتشف المزيد &larr;
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 items-start">
                <div className="bg-[rgb(var(--secondary-light))] text-white p-3 rounded-full">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">خبرة متعددة المجالات</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">فهم عميق للدوافع الإنسانية</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">التزام بالقيم الأخلاقية</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">سجل حافل في ريادة الأعمال</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">مهارات تقنية متقدمة</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">التزام بالتعلم المستمر</h3>
                  <p className="text-[rgb(var(--neutral-medium))]">
