  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-6" dir="rtl">
      <div className="section-container">
        ...
        <header className="mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-4">
            <div className="section-container text-center">
              ...
              <p className="text-sm md:text-xl text-gray-600 mt-1 md:mt-2"> التحول الاستراتيجي الشامل</p>
            </div>
        ...
        {activeTab === 'services' && (
          <div className="space-y-6 md:space-y-8">
                    ...
                    {serviceDistribution.map((service, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center">
                          ...
                          ></div>
                          <span className="font-medium text-sm md:text-base text-blue-900">{service.name}</span>
                        </div>
            ...
            <div className="bg-white rounded-lg md:rounded-xl p-4 md:p-6 shadow-md">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                <div className="h-64 md:h-80">
                  <ResponsiveContainer width="100%" height="100%" className="text-blue-900">
        ...
        {/* Footer */}
        <footer className="mt-8 md:mt-12 py-4 text-sm md:text-base text-gray-500 text-center">
          <p>2024 Winner Advertising - لوحة متابعة التحول الاستراتيجي الشامل</p>
